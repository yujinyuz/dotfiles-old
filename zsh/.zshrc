...
# This function is called everytime `cd` is executed
# function chpwd() {
#   ls -G
# }
...
# ssh
export SSH_KEY_PATH="~/.ssh/id_rsa_mbp"
...
# unsetopt AUTO_CD # zsh automatically executes `cd` when typing folder name
export PATH="/usr/local/opt/gettext/bin:$PATH"
# export GPG_TTY=$(tty)

# Colorize man page by using bat
export MANPAGER="sh -c 'col -bx | bat -l man -p'"

# ZSH vi-mode faster escape response
export KEYTIMEOUT=1


# `z` but remapped to `j` for jumping directly between directories
...
[ -f ~/lazy-load-nvm.sh ] && source ~/lazy-load-nvm.sh
